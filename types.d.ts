...
declare module 'motia' {
  ...
  interface Handlers {
    ...
    'shopvox-webhook': ApiRouteHandler<{ event_object: string; event_action: string; timestamp: number; webhook_token: string; event: { id: string; name: string } }, unknown, { topic: 'sales_order:created'; data: { id: string; name: string } } | { topic: 'sales_order:updated'; data: { id: string; name: string } } | { topic: 'sales_order:deleted'; data: { id: string; name: string } } | { topic: 'quote:created'; data: { id: string; name: string } } | { topic: 'quote:updated'; data: { id: string; name: string } } | { topic: 'quote:deleted'; data: { id: string; name: string } } | { topic: 'work_order:created'; data: { id: string; name: string } } | { topic: 'work_order:updated'; data: { id: string; name: string } }>
